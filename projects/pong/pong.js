...
function checkWin() {
    ...
    if(CPU.score === winningScore) {
        drawText(player.win ="CPU", canvas.width/5.5, canvas.height/2, "white")
        drawText(CPU.win="WINS", 3*canvas.width/4.3, canvas.height/2, "white");
        stopGame();    
    }
    else if (player.score === winningScore) {   
        drawText(player.win ="YOU", canvas.width/5.5, canvas.height/2, "white")
        drawText(CPU.win="WIN", 3*canvas.width/4.3, canvas.height/2, "white");
        stopGame();     
    };   
};
