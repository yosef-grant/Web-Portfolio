function showInfo() {
    ...
    <u>Controls</u>
    <br><br>
    Use the mouse to select a move. 
    <br><br>
    <u>How It Works</u>
    <br><br>
    The entire program is written within the context of the game function. The game is initialised with both
    the player and computer scores set to zero, and event listeners are attached to each DOM element relevant to the game. Available moves 
    for the CPU are contained in a JavaScript object, which is then referenced by a later function. This uses RNG to select a random
